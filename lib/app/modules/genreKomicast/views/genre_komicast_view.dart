...
class GenreKomicastView extends GetView<GenreKomicastController> {
  const GenreKomicastView({Key? key}) : super(key: key);
  @override
            ...
            child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Expanded(
                      child: GetBuilder<GenreKomicastController>(
                        builder: (c) {
