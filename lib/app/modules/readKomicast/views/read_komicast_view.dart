...
class ReadKomicastView extends GetView<ReadKomicastController> {
  const ReadKomicastView({Key? key}) : super(key: key);
  @override
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ReadKomicast chapter = controller.allchapter[index];
