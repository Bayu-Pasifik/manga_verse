...
class MangakalotHomePageView extends GetView<MangakalotHomeController> {
  MangakalotHomePageView({Key? key}) : super(key: key);
                    ...
                    builder: (context, snapshot) {
                      ...
                      return ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          MangakalotAll trending = snapshot.data![index];
                          return GestureDetector(
                            onTap: () => Get.toNamed(Routes.DETAIL_MANGAKALOT,
                ...
                Expanded(
                  child: TabBarView(children: [
                    ...
                    PagedListView<int, MangakalotAll>.separated(
                      ...
                      builderDelegate: PagedChildBuilderDelegate<MangakalotAll>(
